...
class AuditSeverityControllerTests {
	...
	public void testAuditHealthCheck() {
		...
		map.put("message","Audit Severity Microservice is Active");
		assertEquals(severityController.healthCheck(),new ResponseEntity<Map<String,String>>(map,HttpStatus.OK));
	}
